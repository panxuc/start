...
export default function SearchWidget() {
  ...
  return (
    <div className="w-full relative z-30 flex flex-col items-center">
      <div className="flex p-1 mb-6 bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-full border border-white/30 shadow-sm relative">
      ...
      <div
        className={`
          relative w-full transition-all duration-500 ease-out transform
      ...
      >
        <form onSubmit={handleSearch} className="relative group">
          ...
          <button
            type="submit"
            className="absolute right-3 top-3 h-10 w-10 flex items-center justify-center bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 text-gray-600 dark:text-gray-300 rounded-full transition-all active:scale-95"
          >
            ...
            >
              {suggestions.slice(0, 6).map((s, i) => (
                <div
                  ...
                  className="px-6 py-3 hover:bg-white/60 dark:hover:bg-white/10 cursor-pointer text-gray-700 dark:text-gray-200 flex items-center gap-3 transition-colors text-sm sm:text-base"
                >
